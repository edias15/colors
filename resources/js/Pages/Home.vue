    ...
    <Layout>
      <v-card>
        ...
        >
          <template v-slot:top>
            <v-toolbar flat>
              <v-toolbar-title>My Colors</v-toolbar-title>
            ...
            <v-container>
              <v-row>
                <v-col cols="12" sm="6" md="4">
                  <v-color-picker v-model="editedItem.hex" label="Hex" />
                </v-col>
                <v-col cols="12" sm="6" md="4">
                  <v-text-field
...
export default {
  ...
  methods: {
    ...
    deleteItem(item) {
      console.log("Deletando ITEM: ", this.colors.indexOf(item));
      console.log("Deletando ITEM: ", item);
      console.log("Deletando indexOf ITEM: ", this.colors.indexOf(item));
      this.editedIndex = this.colors.indexOf(item);
      this.editedItem = Object.assign({}, item);
